    ...
    >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <strong style={{ fontSize: '14px' }}>⚙️ {text('Global Settings', 'Ustawienia globalne')}</strong>
        ...
        <div style={rowStyle}>
          <span style={labelStyle}>{text('Render quality', 'Jakość renderowania')}</span>
          <div style={{ display: 'flex', gap: '4px' }}>
        ...
        <div style={{ fontSize: '10px', color: '#666', borderTop: '1px solid #333', paddingTop: '8px' }}>
          {text('These settings affect every preview window and are saved in this browser.', 'Ustawienia dotyczą wszystkich okien podglądu i są zapamiętywane w przeglądarce.')}
        </div>
