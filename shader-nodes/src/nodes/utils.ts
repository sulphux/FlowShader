...
export const SplitVec3Node: ShaderNodeDefinition = {
  ...
  outputs: [
    { id: 'x', label: 'X / R', type: 'float' },
    { id: 'y', label: 'Y / G', type: 'float' },
    { id: 'z', label: 'Z / B', type: 'float' }
  ],
...
export const SplitVec4Node: ShaderNodeDefinition = {
  id: 'split_vec4',
  label: 'Split (Vec4)',
  inputs: [{ id: 'in', label: 'Vec4', type: 'vec3' }], // Używamy vec3 w UI jako ogólny kolor, ale GLSL przyjmie vec4
  outputs: [
    { id: 'x', label: 'X / R', type: 'float' },
    { id: 'y', label: 'Y / G', type: 'float' },
    { id: 'z', label: 'Z / B', type: 'float' },
    { id: 'w', label: 'W / A', type: 'float' }
  ],
...
export const CombineVec4Node: ShaderNodeDefinition = {
  ...
  outputs: [{ id: 'out', label: 'Vec4', type: 'vec3' }], // Typ wyjścia w systemie to vec3 (kolor), ale kod to vec4
...
export const MixNode: ShaderNodeDefinition = {
  ...
  inputs: [
    ...
    { id: 't', label: 'T', type: 'float' } // T to suwak blendowania (0.0 - 1.0)
  ],
  outputs: [{ id: 'out', label: 'Out', type: 'vec3' }],
